...
# Import target "Bullet2FileLoader" for configuration "Debug"
set_property(TARGET Bullet2FileLoader APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Bullet2FileLoader PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/Bullet2FileLoader_Debug.lib"
  )

list(APPEND _cmake_import_check_targets Bullet2FileLoader )
list(APPEND _cmake_import_check_files_for_Bullet2FileLoader "${_IMPORT_PREFIX}/debug/lib/Bullet2FileLoader_Debug.lib" )

# Import target "Bullet3Dynamics" for configuration "Debug"
set_property(TARGET Bullet3Dynamics APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Bullet3Dynamics PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/Bullet3Dynamics_Debug.lib"
  )

list(APPEND _cmake_import_check_targets Bullet3Dynamics )
list(APPEND _cmake_import_check_files_for_Bullet3Dynamics "${_IMPORT_PREFIX}/debug/lib/Bullet3Dynamics_Debug.lib" )

# Import target "Bullet3Collision" for configuration "Debug"
set_property(TARGET Bullet3Collision APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Bullet3Collision PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/Bullet3Collision_Debug.lib"
  )

list(APPEND _cmake_import_check_targets Bullet3Collision )
list(APPEND _cmake_import_check_files_for_Bullet3Collision "${_IMPORT_PREFIX}/debug/lib/Bullet3Collision_Debug.lib" )

# Import target "Bullet3Geometry" for configuration "Debug"
set_property(TARGET Bullet3Geometry APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Bullet3Geometry PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/Bullet3Geometry_Debug.lib"
  )

list(APPEND _cmake_import_check_targets Bullet3Geometry )
list(APPEND _cmake_import_check_files_for_Bullet3Geometry "${_IMPORT_PREFIX}/debug/lib/Bullet3Geometry_Debug.lib" )
...
list(APPEND _cmake_import_check_files_for_BulletDynamics "${_IMPORT_PREFIX}/debug/lib/BulletDynamics_Debug.lib" )
