...
Welcome to **MistEngine 0.5.0-prealpha**! This is a modern C++17 game engine — editor + rendering sandbox with AI assistant integration. Contributions are welcome on Windows and Linux.
...
- **"Real-Time Rendering" by M�ller & Haines** - Advanced rendering techniques
